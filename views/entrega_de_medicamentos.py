...
class Ui_EntradaMedicamento(object):
    def setupUi(self, EntradaMedicamento):
        ...
        EntradaMedicamento.resize(737, 527)
        icon = QIcon()
        ...
        EntradaMedicamento.modal=True ##### Cambiar si hay error
...
"color: rgb(0, 0, 0);")
        ...
        self.ql_CtrlEntrada_nacionalidadtext.setMinimumSize(QSize(0, 0))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.LbEjemplo = QLabel(EntradaMedicamento)
        self.LbEjemplo.setObjectName(u"LbEjemplo")
        self.LbEjemplo.setStyleSheet(u"font: 75 9pt \"MS Shell Dlg 2\";")

        self.gridLayout_2.addWidget(self.LbEjemplo, 0, 2, 1, 1)
...
#      ************************ ACCIONES ADICIONALES  *********************************************
        comboGrid(self)
        #self.qlinee_CtrlEntrada_cedulainfo.textChanged.connect(self.LbEjemplo.setText(self.qlinee_CtrlEntrada_cedulainfo.text()))
    ...
    def retranslateUi(self, EntradaMedicamento):
        ...
        self.qplt_CtrlEntrada_direccioninfo.setPlaceholderText("")
        ...
        #self.qlinee_CtrlEntrada_nombreinfo.setCursor(0)
        self.qlinee_CtrlEntrada_nombreinfo.setPlaceholderText(QCoreApplication.translate("EntradaMedicamento", u"Inserte sus nombres", None))
        ...
        self.qlinee_CtrlEntrada_apellidosinfo.setPlaceholderText(QCoreApplication.translate("EntradaMedicamento", u"Inserte sus dos Apellidos", None))
        ...
        self.qlinee_CtrlEntrada_cedulainfo.setPlaceholderText(QCoreApplication.translate("EntradaMedicamento", u"Introduzca su n\u00famero de c\u00e9dula", None))
        ...
        self.LbEjemplo.setText(QCoreApplication.translate("EntradaMedicamento", u"   Ej:26582589 ", None))
